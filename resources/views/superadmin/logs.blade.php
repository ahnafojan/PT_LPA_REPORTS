<x-layouts::app :title="__('Log Aktivitas')">
    <section class="rounded-md bg-white p-6 shadow-sm ring-1 ring-[#d8edd8]">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <input type="search" placeholder="Cari aktivitas..." class="rounded-md border border-[#d6ead5] px-4 py-2 text-sm">
        </div>
        <div class="mt-6 space-y-3">
            @foreach ([
                ...
                <div class="grid gap-2 rounded-md bg-[#f7fbf6] p-4 ring-1 ring-[#d8edd8] md:grid-cols-[180px_1fr_180px]">
