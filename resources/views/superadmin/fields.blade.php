    ...
    <div class="grid gap-6 xl:grid-cols-[420px_1fr]">
        <section class="rounded-md bg-white p-6 shadow-sm ring-1 ring-[#F2F4F7]">
            ...
            <form class="mt-6 space-y-4">
                ...
                <input type="text" placeholder="Label field" class="w-full rounded-md border border-[#F2F4F7] px-4 py-3 text-sm outline-none focus:border-[#004D26] focus:ring-2 focus:ring-[#004D26]/60">
                <x-alpine-dropdown
                    name="tipe_field"
                    :options="['Text', 'Number', 'Date', 'Dropdown']" />
                <input type="number" placeholder="Urutan" class="w-full rounded-md border border-[#F2F4F7] px-4 py-3 text-sm outline-none focus:border-[#004D26] focus:ring-2 focus:ring-[#004D26]/60">
                <label class="flex items-center gap-2 rounded-md bg-[#F2F4F7] px-4 py-3 text-sm font-semibold text-slate-600 ring-1 ring-[#F2F4F7]">
                    <input type="checkbox" checked class="h-4 w-4 rounded border-[#F2F4F7] text-[#004D26]">
                    Wajib diisi
                </label>
